...
public final class Config {
	...
	public static final String BUG_REPORTS = "bugs@vicicode.com";


	public static final String DOMAIN_LOCK = "vicicode.com"; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "vicicode.com";
